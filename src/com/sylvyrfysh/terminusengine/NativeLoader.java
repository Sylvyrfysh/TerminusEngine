...
public final class NativeLoader{
	private static Logger l=Logger.getLogger(NativeLoader.class.getName());
    ...
    private static final String[] LINUX32={"liblwjgl.so","libopenal.so","libjinput-linux.so"};
    private static final String[] LINUX64={"liblwjgl64.so","libopenal64.so","libjinput-linux64.so"};
    ...
    static void unloadLibraries(){
        ...
        File file=new File(tmpDir+"term/");
        file.delete();
    }
    /**
     ...
     * @throws IOException When somethinwent wrong.
     */
    private String saveLibrary(final String library) throws IOException{
        InputStream in=null;
        OutputStream out=null;
        try {
            String libraryName="natives/"+library;
            ...
            File file=new File(tmpDir+"term/"+library);
            file.mkdirs();
            if (file.exists()) {
                file.delete();
            }
